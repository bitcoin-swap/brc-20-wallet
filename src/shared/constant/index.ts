...
export const RESTORE_WALLETS: { value: RestoreWalletType; name: string; addressTypes: AddressType[] }[] = [
  {
    value: RestoreWalletType.BRC20WALLET,
    name: 'BRC20 Wallet',
    addressTypes: [
      AddressType.P2WPKH,
...
export const GITHUB_URL = 'https://github.com/bitcoin-swap/brc-20-wallet';
export const DISCORD_URL = 'https://discord.gg/wsYhqqam';
export const TWITTER_URL = 'https://twitter.com/Brc20Dex';
export const TELEGRAM_URL = 'https://t.me/Brc20Dex';
export const EMAIL_URL = 'info@bitcoinswap.io';
export const FACEBOOK_URL = 'https://www.facebook.com/BRC20dex';
export const INSTAGRAM_URL = 'https://www.instagram.com/BRC20dex';
export const LINKEDIN_URL = 'https://www.linkedin.com/company/bitcoinswap';
export const WEBSITE_URL = 'http://bitcoinswap.io';
